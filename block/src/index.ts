...
import { platforma } from "@platforma-open/milaboratories.humanness-score.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type HumannessScoreBlockContract = BlockContract;
export type HumannessScoreBlockOutputs  = BlockOutputs;
export type HumannessScoreBlockData     = BlockData;
export const HumannessScoreBlockPointer = BlockPointer;
